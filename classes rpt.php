...
<div class="container2 	">
      ...
      <!--<div class="container">-->
           <h1 style="font-size:30px; text-align:center;">classes Report </h1>
    <hr>
...
<td> <?php echo $row["mobile"];?> </td>
                ...
                <td style="text-align:center"><a href="classes rpt.php?classid=<?php echo $row['classid']; ?>" onclick="return confirm('Are you sure you want to delete Classes?')">delete 	</a>
                </td>
              </tr>
              <?php
                $i++;
