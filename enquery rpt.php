...
if(isset($_GET['eid'])){
       $id= mysqli_real_escape_string($connect,$_GET['eid']);
    $sql_delete ="DELETE FROM enquiry WHERE eid={$id}";
...
<a  style="text-align:left; margin-top:10px; margin-left:-55%; font-family: inherit;font-size: 30px;" href="enquery rpt.php"> Enquery rpt</a>&nbsp;&nbsp;<b>|</b>&nbsp;
<a  style="text-align:left; margin-left:1%; font-family: inherit;font-size: 30px;" href="DatewiseEnqueryrpt.php">Date wise Enquery rpt</a>
</span>   
          </div>
        </div>
...
<td> <?php echo $row["description"];?> </td>
                ...
                <td style="text-align:center"><a href="enquery rpt.php?eid=<?php echo $row['eid']; ?>" onclick="return confirm('Are you sure you want to delete this enquery?')">delete 	</a>
                </td>
              </tr>
              <?php
                $i++;
