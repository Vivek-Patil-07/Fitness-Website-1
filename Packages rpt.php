...
if(isset($_GET['packid'])){
       $id= mysqli_real_escape_string($connect,$_GET['packid']);
    $sql_delete ="DELETE FROM packages WHERE packid={$id}";
...
<?php include ("adminnav.php")?>
 <div class="intro-section" id="home-section" style="background-color: #ccc;">
  ...
  <div class="row align-items-center">
          ...
          <span> 
<h1 style="text-align:left; margin-top:10%; margin-left:07%; font-family: inherit;font-size: 30px;">Packages</h1>
</span>   
          </div>
        </div>
...
<td> <?php echo $row["description"];?> </td>
                ...
                <td style="text-align:center"><a href="Packages rpt.php?packid=<?php echo $row['packid']; ?>" onclick="return confirm('Are you sure you want to delete packages?')">delete 	</a>
                </td>
              </tr>
              <?php
                $i++;
