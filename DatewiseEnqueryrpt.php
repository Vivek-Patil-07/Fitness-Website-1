...
<div class="container2">
  ...
  <div class="container5">
        ...
        <h1 style="font-size:30px; text-align:center;">Date wise Enquery Report </h1>
    <hr>
	...
	<div class="row" style="margin-top:5px;">
                        ...
                        <div class="col-sm-12">
<button type="submit" name="submit" class="registerbtn" formaction="DatewiseEnquerylist.php">Submit</button>
  </div>
</div>
  </div>
</form>
