...
if(isset($_GET['userid'])){
    ...
    $sql_delete ="DELETE FROM booking WHERE userid={$id}";
...
<?php include ("adminnav.php")?>
 <div class="intro-section" id="home-section" style="background-color: #ccc;">
  ...
  <div class="row align-items-center">
          ...
          <span> 
<h1 style="text-align:left; margin-top:10%; margin-left:07%; font-family: inherit;font-size: 30px;">Booking</h1>
</span>   
          </div>
        </div>
...
<div class=" container2	">
    ...
    <table class="table table-responsive"style="width:564px; margin-top:10px; " align="center" > 
	 <?php 
...
<td> <?php echo $row["mobno"];?> </td>
                ...
                <td style="text-align:center"><a href="personaltrainer rpt.php?userid=<?php echo $row['userid']; ?>" onclick="return confirm('Are you sure you want to delete this enquery?')">delete 	</a>
                </td>
              </tr>
              <?php
                $i++;
