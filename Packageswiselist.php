<?php
  ...
  $cname=$_POST['packtype']; 
		
		
if(isset($_GET['classid'])){
       $id= mysqli_real_escape_string($connect,$_GET['classid']);
    $sql_delete ="DELETE FROM classes WHERE classid={$id}";
...
<?php include ("adminnav.php")?>
 <div class="intro-section" id="home-section" style="background-color: #ccc;">
  ...
  <div class="row align-items-center">
          ...
          <span><h1 style="text-align:center; font-size: 36px;
    border: ridge;
    font-family: none;">[ <span style="color:red;"><?php echo $cname;?></span> ] packages wise Classes List</h1>
	</span>   
          </div>
        </div>
...
<div class=" container2	">
    ...
    <table class="table table-responsive"style="width:850px; margin-top:10px; " align="center" > 
	 <?php 
                //$sql = "select * from studentadmission Order by StudId desc";
                $sql = "select * from classes where packtype='$cname'";
...
<td> <?php echo $row["mobile"];?> </td>
               <td style="text-align:center"><a href="Packageswiselist.php?classid=<?php echo $row['classid']; ?>" onclick="return confirm('Are you sure you want to delete classes?')">delete 	</a>
                </td>
