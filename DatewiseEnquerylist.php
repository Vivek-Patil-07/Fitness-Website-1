...
<?php include ("adminnav.php")?>
 <div class="intro-section" id="home-section" style="background-color: #ccc;">
  ...
  <div class="row align-items-center">
    ...
    border: ridge;
    font-family: none;">Date wise Enquiry List<br><span style="color:red;font-size:20px;">From : <?php echo $appdate1;?>  To : <?php echo $appdate2;?> </span></h1>
          </div>
        </div>
...
<div class=" container2	">
    ...
    <table class="table table-responsive"style="width:100%; margin-top:10px; " align="center" > 
	 <?php 
               ...
               $sql = "select * from enquiry where appdate>='$appdate1' and 	appdate<='$appdate2'";
